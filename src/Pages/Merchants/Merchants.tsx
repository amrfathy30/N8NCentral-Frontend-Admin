...
const getColumns = () => {
        ...
        if (activeFilter === "verified") {
            return [
                ...
                { header: t("Merchants.TotalSales"), field: "sales" },
                ...
                },
                {
                    ...
                    body: (row: any) => (
                        <div className="flex gap-2 items-center justify-center">
                            <button onClick={() => { setSelectedMerchant(row); setIsModalOpen(true); }} className="bg-greenDark text-white px-6 py-3 rounded-lg text-xs font-bold hover:opacity-90">{t("Merchants.View")}</button>
                            <button className="bg-[#F68713] text-white px-6 py-3 rounded-lg text-xs font-bold hover:opacity-90">{t("Merchants.Stop")}</button>
                            <button className="bg-[#E7000B] text-white px-6 py-3 rounded-lg text-xs font-bold hover:opacity-90">{t("Merchants.Blocked")}</button>
                        </div>
                    ),
                },
            ];
                ...
                },
                {
                    ...
                    body: (row: any) => (
                        <div className="flex gap-2 justify-center">
                            <button onClick={() => { setSelectedMerchant(row); setIsModalOpen(true); }} className="bg-greenDark text-white px-6 py-3 rounded-lg text-xs font-bold hover:opacity-90">{t("Merchants.ViewDetails")}</button>
    ...
    return (
        <div className="space-y-8" dir={dir}>
            ...
            <VerificationDetails isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} data={selectedMerchant} />
        </div>
    );
}
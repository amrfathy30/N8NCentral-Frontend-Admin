        ...
        <div className="flex justify-center items-center gap-2">
            {rowData.status === "Approved" ? (
                ...
                <>
                    ...
                    <button className="bg-orange-500 text-white px-6 py-2.5 rounded-lg text-xs font-bold hover:bg-opacity-90 transition-all flex items-center gap-1">
                        {t("Common.Adoption")}
                    </button>
                    <button className="bg-red-500 text-white px-6 py-2.5 rounded-lg text-xs font-bold hover:bg-opacity-90 transition-all flex items-center gap-1">
                        {t("Common.Reject")}
                    </button>
                </>
            )}
